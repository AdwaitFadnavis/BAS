		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#adwaitgitFiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"adwaitgitFiori-display": {
								"semanticObject": "adwaitgitFiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=adwaitgitFiori",
									"url": sap.ui.require.toUrl("adwaitgitFiori")
								}
							}
						}
					}
